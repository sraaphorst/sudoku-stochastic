...
//                }
                ...
                // Change the best solution if necessary, and if it is sufficient, return it.
                if (nextGeneration[max]->fitness() > best->fitness())
                    best = options.populator->survive(nextGeneration[max]);
